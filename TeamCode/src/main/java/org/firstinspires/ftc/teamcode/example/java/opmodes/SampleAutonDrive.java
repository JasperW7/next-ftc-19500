...
@Autonomous(name = "Sample Drive", group = "Autonomous")
public class SampleAutonDrive extends PedroOpMode {
    public SampleAutonDrive() {
    ...
    private final Pose parkControlPose = new Pose(61, 121, Math.toRadians(90));
    ...
    public Command firstRoutine() {
        return new SequentialGroup(
                new FollowPath(scorePreload).thenWait(2),
                new FollowPath(grabPickup1,true).thenWait(2),
                new FollowPath(scorePickup1,true).thenWait(2),
                new FollowPath(grabPickup2,true).thenWait(2),
                new FollowPath(scorePickup2,true).thenWait(2),
                new FollowPath(grabPickup3,true).thenWait(2),
                new FollowPath(scorePickup3,true).thenWait(2)
//                // SCORE 1
//                new ParallelGroup(
